...
## research  
Every network-based method in cancer genomics relies on the assumption that driver genes sit close together in the protein interaction network, because cancer works by breaking pathways rather than individual genes. The edges in an interaction network are records of experiments 
